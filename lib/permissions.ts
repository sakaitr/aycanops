...
export const PERMISSIONS = {
  ...
  finans_masraf_talebi: ["read", "create", "delete", "approve", "reject"],
  ...
  finans_kategori_grubu: ["read", "create", "update", "delete"],
  finans_kisisel_butce: ["read", "create", "update", "delete"],
  nav_config: ["update"],
