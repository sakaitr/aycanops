...
export const REPORT_CATALOG: ReportDef[] = [
  ...
  // C — Denetim & Kalite
  { id: 8,  slug: "arac-denetim",        name: "Araç Denetim Raporu",       category: "Denetim & Kalite",   description: "Denetim sonuçları: geçti / kaldı / şartlı dağılımı",           needsCompany: true,  needsDate: true,  needsVehicle: true,  chartTypes: ["donut"],             roleMin: "yetkili"  },
